...
*最后更新：2026-06-29（14-mcp-encoding-fix 归档：unity-skills CJK 端到端修复落地，4 路防御 + 20/20 回归 + 7/7 live round-trip；spec sink 落 mcp-encoding-fix；wiki 新增「unity-skills CJK 编码修复」；活跃 change 收敛为 06-v21 + 10-settings-form）*
