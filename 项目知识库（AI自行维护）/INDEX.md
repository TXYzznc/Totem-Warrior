...
- **[初版 GDD 设计文档（2026-06 baseline）](wiki/初版GDD设计文档.md)** — 2026-06-25 — 项目立项阶段（2026-06-22~23）的初版 GDD，9 份文档涵盖玩法定位（Roguelike + BR）、纹身构筑系统（6×7×8 三层正交）、世界观（多元末日 + 实验体）、联机三层架构、技术选型。原始素材见 [raw/初版GDD-2026-06/](raw/初版GDD-2026-06/)。已派生 [01-tattoo-framework-rewrite](../openspec/changes/01-tattoo-framework-rewrite/) 落地。
...
> 05-codex-batch-art-protocol 已 archive 到 `openspec/changes/archive/2026-06-25-05-codex-batch-art-protocol/`，详见 [wiki 条目](wiki/Codex批量出图协议.md)。
...
*最后更新：2026-06-25（迁移「开发文档/」9 份初版 GDD 到 raw/初版GDD-2026-06/，新增 wiki 索引条目「初版 GDD 设计文档」）*
