...
*最后更新：2026-07-01（18-weapon-pickup-and-upgrade + 19-visual-polish 双归档：武器拾取/升级三路径骨架先行+并行填充 / 视觉打磨 4 项 + 8 个已知限制全 P3 非阻塞；Auto Mode 无人值守跑完 ROADMAP §0 Phase A/B/C；活跃 change 收敛为 06-v21 + 10-settings-form）*
