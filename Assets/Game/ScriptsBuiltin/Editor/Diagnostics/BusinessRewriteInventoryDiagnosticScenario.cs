...
namespace UGF.EditorTools
{
    public sealed class BusinessRewriteInventoryDiagnosticScenario : GFDiagnosticScenarioBase
    {
        ...
        private const string ProjectMapPath = "项目知识库（AI自行维护）/PROJECT_MAP.md";
        private const string ActiveContextPath = "项目知识库（AI自行维护）/ACTIVE_CONTEXT.md";
        ...
        private const string DataTablesManifestPath = "项目知识库（AI自行维护）/manifests/datatables.json";
        private const string FeatureSlicesManifestPath = "项目知识库（AI自行维护）/manifests/feature_slices.json";
        private const string DiagnosticTriageManifestPath = "项目知识库（AI自行维护）/manifests/diagnostic_triage.json";
