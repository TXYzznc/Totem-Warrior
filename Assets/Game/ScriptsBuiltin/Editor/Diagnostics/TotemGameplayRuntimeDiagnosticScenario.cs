...
namespace UGF.EditorTools
{
    public sealed class TotemGameplayRuntimeDiagnosticScenario : GFDiagnosticScenarioBase
    {
        ...
        private static void CheckMapLayout(GFDiagnosticScenarioContext context)
        {
            ...
            context.AssertEqual(TotemMapService.PcgMapWidth, map.PcgWidth, "map.pcg.width");
            context.AssertEqual(TotemMapService.PcgMapHeight, map.PcgHeight, "map.pcg.height");
        ...
        private static void CheckMapRuntimeObjects(GFDiagnosticScenarioContext context)
        {
            ...
            try
            {
                ...
                context.Assert(snapshot.pcgCellObjectCount >= TotemMapService.PcgMapWidth * TotemMapService.PcgMapHeight, "Map runtime should place one ground tile per PCG cell.");
